...
export const mockPastOrders: (Order & { date: string })[] = [
  { id: 'past-001', items: [{ id: 'm1', name: 'Stadium Burger', description: '', price: 450, category: 'food', image: '🍔', quantity: 2, popular: true }, { id: 'm3', name: 'Craft IPA', description: '', price: 380, category: 'drinks', image: '🍺', quantity: 2 }], total: 1210, status: 'delivered', deliveryType: 'seat', estimatedMinutes: 0, date: '2026-04-05' },
