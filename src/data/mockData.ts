...
export const mockMenu: MenuItem[] = [
  ...
  { id: 'm3', name: 'Classic Hot Dog', description: 'All-beef frank, your choice of toppings', price: 300, category: 'food', image: '🌭', popular: true },
  { id: 'm4', name: 'Chicken Tenders', description: 'Crispy tenders with ranch', price: 400, category: 'food', image: '🍗' },
  { id: 'm5', name: 'Craft IPA', description: 'Local brewery seasonal', price: 380, category: 'drinks', image: '🍺', popular: true },
  { id: 'm6', name: 'Frozen Margarita', description: 'Classic lime, salt rim', price: 550, category: 'drinks', image: '🍹' },
  { id: 'm7', name: 'Soda', description: 'Coca-Cola, Thums Up, or Limca', price: 150, category: 'drinks', image: '🥤' },
  { id: 'm8', name: 'Water', description: 'Bottled mineral water', price: 100, category: 'drinks', image: '💧' },
  { id: 'm9', name: 'Team Jersey', description: 'Official replica jersey', price: 2100, category: 'merch', image: '👕' },
  { id: 'm10', name: 'Rally Towel', description: 'Game day rally towel', price: 600, category: 'merch', image: '🏳️' },
];
